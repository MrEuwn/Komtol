...
tools(){
    ...
    echo -e $blue "[2] > theonionguy (linux only)"
    echo -e $blue "[3] > Reverse IP"
    echo -e $blue "[4] > PhoneSpoofing"
    echo -e $blue "[5] > F-Backup"
    echo -e $blue "[6] > Database Searcher"
    echo -e $blue "[7] > wherethedirectory"
    echo -e $blue "[8] > Go-Server"
    echo -e $blue "[9] > Andromeda"
    echo -e $blue "[10] > RoseKiller"
    echo -e $blue "[11] > Malware_Hunter"
    echo -e $blue "[12] > Termux-Key"
    echo -e $blue "[13] > Wikipedia_Search"
    echo -e $blue "[14] > IpTracker"
    echo -e $blue "[15] > Dork Search"
    echo -e $blue "[16] > Social Media"
    echo -e $blue "[17] > Who Are You"
    echo -e $blue "[18] > CSRD-Uploader"
    echo -e $blue "[19] > XSS-Exploiter"
    echo -e $blue "[20] > KcfinderExploiter"
    echo -e $blue "[21] > Infogathering"
    echo -e $blue "[22] > Cryptography"
    echo -e $blue "[23] > Base64Encode"
    echo -e $blue "[24] > ShellFinder"
    echo -e $blue "[25] > Text To Binary"
    echo -e $blue "[26] > Admin Search"
    echo -e $blue "[27] > Upload Finder"
    echo -e $blue "[28] > Matthew Bot"
    echo -e $blue "[29] > NetScan"
    echo -e $blue "[30] > F-Dos"
    echo -e $blue "[31] > HashMaker"
    echo -e $blue "[32] > GitInform"
    echo -e $blue "[33] > XSploit"
    echo -e $blue "[34] > NetWorkSpoofing"
    echo -e $blue "[35] > MetaBot"
    echo -e $blue "[36] > CekCuaca (Termux only)"
    echo -e $blue "[37] > Sqlbot"
    echo -e $blue "[38] > Take All Repo"
    echo -e $blue "[39] > Termux GUI"
    echo -e $blue "[40] > Wordpress-Exploit"
    echo -e $blue "[41] > RED HAWK"
    echo -e $blue "[42] > Sqlmap"
    echo -e $blue "[43] > JohnTheRipper"
    echo -e $blue "[44] > Evil Droid"
    echo -e $blue "[45] > Striker"
    echo -e $red "[0] > Exit"
